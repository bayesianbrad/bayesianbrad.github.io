...
The Leapfrog integrator has the property that it is volume preserving and has low local and global errors **#OhLaLa**,
thus it is the integrator of choice when implementing HMC.
